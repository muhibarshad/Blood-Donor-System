    ...
    if (file.is_open())
    {
        for (int i = 0; i < index && found == false; i++)
        {
            ...
            if (donor[i].name == updateBy_name)
            {
                ...
                cout << "\t\t\t   Enter the date of the updated Donation:" << endl;
        ...
        // // storing updated data into the temprecord sturcture
        // for (int i = 0; i < index; i++)
        // {
        //     temp.read(reinterpret_cast<char *>(&donor[i]), sizeof(record));
        //     tempDonors[i].name = donor[i].name;
        //     tempDonors[i].rollNum = donor[i].rollNum;
        //     tempDonors[i].PhoneNum = donor[i].PhoneNum;
        //     tempDonors[i].bloodGroup = donor[i].bloodGroup;
        //     tempDonors[i].no_ofDonate = donor[i].no_ofDonate;
        //     tempDonors[i].dateof_Donation = donor[i].dateof_Donation;
        //     tempDonors[i].permanentAddress = donor[i].permanentAddress;
        // }
        
        // // writing updated data to the original file
        // file.open("bds_donor_data.txt", ios::out | ios::binary);
        // for (int i = 0; i < index; i++)
        // {
        //     file.write(reinterpret_cast<char *>(&tempDonors[i]), sizeof(record));
        // }
